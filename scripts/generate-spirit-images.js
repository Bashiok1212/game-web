#!/usr/bin/env node
'use strict';
// 妖灵图片生成：与 generate-item-images.js 用法一致，运行即生成到 public/images/spirits/
// 执行：node scripts/generate-spirit-images.js
const fs = require('fs');
const path = require('path');

const OUT_DIR = path.join(__dirname, '..', 'public', 'images', 'spirits');
...
console.log('Generated 151 spirit images in ' + OUT_DIR);
